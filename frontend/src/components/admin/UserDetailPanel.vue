...
import { adminStatusLabel, formatAdminDate, formatAdminDt } from "../../utils/admin";
        ...
        <div class="admin-detail-body">
          <form class="admin-detail-form" @submit.prevent="submit">
            ...
            <dl class="admin-detail-stats">
              ...
              <div>
                <dt>최근 접속</dt>
                <dd>{{ user.lastAccess ? formatAdminDt(user.lastAccess) : "없음" }}</dd>
              </div>
              <div>
                <dt>최근 근무 기록</dt>
